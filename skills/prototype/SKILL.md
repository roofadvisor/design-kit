...
## Steps
1. Read `${CLAUDE_PLUGIN_ROOT}/kit/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`${CLAUDE_PLUGIN_ROOT}/kit/tokens/*`), components (`${CLAUDE_PLUGIN_ROOT}/kit/components/*`), taste (`${CLAUDE_PLUGIN_ROOT}/kit/taste/*`), and a11y (`${CLAUDE_PLUGIN_ROOT}/kit/accessibility/*`).
