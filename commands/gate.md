...
1. Run: `node ${CLAUDE_PLUGIN_ROOT}/kit/scripts/accuracy_report.mjs`
...
4. For any rendered HTML touched this session, also run the pixel-truth checks
   ...
   - `node ${CLAUDE_PLUGIN_ROOT}/kit/scripts/verify_states.mjs <file> [--dark]`
   - `node ${CLAUDE_PLUGIN_ROOT}/kit/scripts/verify_responsive.mjs <file>`
...
They do not prove taste. Pair with `node ${CLAUDE_PLUGIN_ROOT}/kit/scripts/taste_audit.mjs` + human review;
